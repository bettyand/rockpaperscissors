...
const getHand = () => Math.floor(Math.random() * hands.length);
...
const getName = () => "this worked";

function getLength (func) { return func() };
...
module.exports = { hands, getHand, betty, chris, joseph, darci, playRound, playGame, playTournament, getName, getLength };